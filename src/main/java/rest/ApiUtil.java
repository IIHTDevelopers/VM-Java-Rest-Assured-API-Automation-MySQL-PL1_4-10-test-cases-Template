...
public class ApiUtil {
	...
	public CustomResponse GetLogin(String endpoint, String cookieValue, Map<String, String> body) {
		...
		Response response = null; // ✅ Send the request
		int statusCode = 0;
	...
	public CustomResponse GetDashboardShortcut(String endpoint, String cookieValue, Map<String, String> body) {
		...
		int statusCode = 0;
		String statusLine = null;
		Boolean leaveAssignLeave = false;
		Boolean leavLeaveList = false;
		Boolean leaveApplyLeave = false;
		Boolean leaveMyLeave = false;
		Boolean timeEmployeeTimesheet = false;
		Boolean timeMyTimesheet = false;
	...
	public CustomResponse PutEmpName(String endpoint, String cookieValue, Object body) {
		...
		// Extract currencies
		List<String> currencyDetails = null;
